...
*이 문서는 `Common/PERSONA.md`에 정의된 범용 에이전트 규칙을 상속받습니다. 기본 규칙이 모두 적용되며, 아래에는 YiSan 프로젝트에만 해당하는 특화 정보가 기술되어 있습니다.*
...
- **네트워크 로깅**: `NETWORK_LOG` 카테고리는 `CoffeeLibrary/Public/Shared/NetworkLog.h`에 정의되어 있으므로 필요 시 확장한다.
...
## 관련 문서
- **코딩 컨벤션**: `Project/YiSan/CODING_CONVENTIONS.md` (YiSan 프로젝트별 네트워크/모듈 규칙)
- **범용 언리얼 규칙**: `Common/UnrealEngine/ue_coding_conventions.md`
- **Doxygen 설정**: `Project/YiSan/DOXYGEN_SETUP.md`
